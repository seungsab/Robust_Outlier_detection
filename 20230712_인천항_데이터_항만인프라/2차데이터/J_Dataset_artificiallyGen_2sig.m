...
% Make Outliers
driftAmount(1) = -pdnum(1,2)*1;
driftAmount(3) = -pdnum(3,2)*1;

driftAmount(2) = pdnum(2,2)*1;
driftAmount(4) = -pdnum(4,2)*1;

driftAmount(5) = pdnum(5,2)*2;
driftAmount(7) = pdnum(7,2)*2;

driftAmount(6) = pdnum(6,2)*2;
driftAmount(8) = pdnum(8,2)*2;
...
%     set(gca,'FontSize',16,'XLim',[t(1) t_out(end)],'YLim',YL(i,:))e
...
figure
plot(Label_1,'LineWidth',2); hold on; plot(Label_2,'LineWidth',2);
...
writetable(Dataset,'J_Dataset_1101_0630_outlier_2sig.csv')
