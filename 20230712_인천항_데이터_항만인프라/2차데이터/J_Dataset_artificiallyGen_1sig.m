...
driftAmount(5) = pdnum(5,2)*1;
driftAmount(7) = pdnum(7,2)*1;

driftAmount(6) = pdnum(6,2)*1;
driftAmount(8) = pdnum(8,2)*1;
...
writetable(Dataset,'J_Dataset_1101_0630_outlier_1sig.csv')
