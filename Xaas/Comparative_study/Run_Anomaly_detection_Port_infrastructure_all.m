...
fn = [pwd '\Data\CG_1_sig1_12.csv']; fn_type = 1;
fn = [pwd '\Data\TT_1_sig1_12.csv']; fn_type = 2;
fn = [pwd '\Data\CG_1&CG_2_sig0_3_12.csv']; fn_type = 3;
fn = [pwd '\Data\CG_1&CG_2&TT_1_sig0_3_12.csv']; fn_type = 4;

data = importdata(fn);
time_stamp = data.textdata(2:end,1);
time_stamp = datetime(time_stamp);
data.data = data.data(1:end, :);
