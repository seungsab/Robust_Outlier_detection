...
class pca_online():
    ...
    def __init__(self, component_use='major', gmm_run=1, n_sample_max=1e4, method_Ncomp='eigengap', method_thresh='percentile', cutoff=0.95, n_stall=5, alpha=0.99, n_comp_min=1, n_comp_max=3, cv_types=["spherical", "tied", "diag", "full"], score_type='SPE', kmeans_n_clusters_min=2, kmeans_n_clusters_max=3):
        # BASELINE MODEL
